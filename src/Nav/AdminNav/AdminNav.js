                    ...
                    <div className="Navbody">
                        ...
                        <div className="Acounts">
                            ...
                            <NavLink onClick={()=>setIsActive(
                                (prev) => ({...prev, comingsoon: false, 
                                dashBoard: false, ProManagement: false,
                                indevelop: false , userManagement: false ,staffManagement: true})
                            )} to={"Admin/StaffManagement"} style={{textDecoration: "none", color: "black"}} className={isActive.staffManagement ? "active" : "normal"}>
                                <div className="Acountbar d-flex">
                                    <FontAwesomeIcon icon={faClipboardUser} style={{paddingLeft: "4px", fontSize: "24px"}} className="ic3"/>
                                    <p style={{marginLeft: "2%"}} className="p6">Staff Management</p>
                                </div>
                            </NavLink>
