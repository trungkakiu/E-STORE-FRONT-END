...
const FetchProduct = async (productID, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/api/product/product/${productID}`,
      {},
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
const fetchCategory = async (cateID) => {
  try {
    if (cateID) {
      const response = await axios.get(
...
const AddCategory = async (data, token) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/api/category/add-category`,
      {
        name: data.cateName,
...
const DeleteCategory = async (categoryId, token) => {
  try {
    const response = await axios.delete(
      `${API_BASE_URL}/api/category/delete-category/${categoryId}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
const UpdateCategory = async (data, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}/api/category/update-category/${data.CataID}`,
      {
        name: data.cateName,
...
const FetchAllUser = async (token, role) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/api/user/users`, {
      params: { limit: 9999999, role: role },
      headers: { Authorization: `Bearer ${token}` },
    });
...
const handleEditProduct = async (NewData, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}/api/product/update-product/${NewData.id}`,
      {
        brand: NewData.brand,
...
const fetchVouCher = async (isShow) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/api/discount/list?available_filter=${isShow}`
    );
    return response;
  } catch (error) {
    console.error(error);
...
const AddnewVoucher = async (VoucherData, token) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/api/discount/create`,
      {
        code: VoucherData.code,
        discount_percent: VoucherData.discount,
        expiration_date: VoucherData.exprDate,
        max_users: VoucherData.maxuser,
        minimum_order_value: VoucherData.minprice,
      },
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
const RemoveVC = async (VCID, token) => {
  try {
    const response = await axios.delete(
      `${API_BASE_URL}/api/discount/delete/${VCID}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
const fetchUserVoucher = async (token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/api/discount/my-discounts`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
const AddUserVoucher = async (disCountID, token) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/api/discount/collect/${disCountID}`,
      {},
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
const FecthOrder = async (token) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/api/order/admin/list`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response;
  } catch (error) {
...
const OrderStatusChange = async (status, OrderID, token) => {
  try {
    const response = await axios.put(
      `${API_BASE_URL}/api/order/update-status/${OrderID}`,
      {
        status: status,
      },
      {
...
const ProductRatting = async (PrdID, data, token) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/api/review/add-review/${PrdID}`,
      {
...
const GetProductRating = async (userID, token) => {
  try {
    const response = await axios.get(
...
const fetchProductRatting = async (PrdID, token) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/api/review/product/${PrdID}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
const RemoveComment = async (RvID, token) => {
  try {
    const response = await axios.delete(
      `${API_BASE_URL}/api/review/delete/${RvID}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
