...
const Productmanagements = () => {
  ...
  const { products, fetchProducts, fecthCategory } = useContext(ProductContext);
    ...
    <div className="Prt-container">
      <div className="dashboard">
        <div className="topcontent d-flex">
          <div
            onClick={() => setisChoose("all")}
            className={
              isChoose === "all" ? "choose allproduct bar" : "allproduct bar"
            }
          >
          ...
          <div
            onClick={() => setisChoose("sale")}
            className={
              isChoose === "sale" ? "choose sellinday bar" : "sellinday bar"
            }
          >
          ...
          <div
            onClick={() => setisChoose("order")}
            className={
              isChoose === "order" ? "choose orderinday bar" : "orderinday bar"
            }
          >
