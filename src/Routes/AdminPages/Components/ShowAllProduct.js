...
import { faChartBar, faLayerGroup, faPlus, faSearch, faXmark } from "@fortawesome/free-solid-svg-icons";
...
const ShowAllProducts = () => {
    ...
    const filterProduct = Array.isArray(products) ? products.filter(item =>
    ...
    return (
        <div className="cart-container"> 
            <AddCategory show={isOpen.Addcate} close={() => closeModal("Addcate") } data={categories || {}} />
            <DeleteCate show={isOpen.Dellcate} close={() => closeModal("Dellcate")} data={deleteID || {}} />
            <UpdateCategory 
            ...
            <div className="productbycategory">
                <div className="cl992">
                    <div className="div9982 d-flex">
                        ...
                        <div onClick={() => openModal("Addcate")} style={{ width: "50px" }} className="cate991 d-flex">
                                ...
                                <div className="product">
                                    <div className="find d-flex">
                                        <div className="div8872 f-flex">
                                            ...
                                            <input onChange={(e)=>setSearhProduct(e.target.value) } placeholder="Find product here"/>
                                        </div>
                                        <div>
                                            <select 
                                        ...
                                        { filterProduct.map((item, index) => {
                                            ...
                                            return (
                                                ...
                                                <div key={index} className="card">
                                                        <Link state={{ data: item }} style={{textDecoration: "none", color: "black", cursor: "pointer"}} to={"/Admin/Detail-Product"}>
                                                    <div className="topcard">
                                                        <img className="Primg" src={`${IMGPATH}=${defaultImage?.url  || "default.jpg"}`} />
                                                    </div>   
