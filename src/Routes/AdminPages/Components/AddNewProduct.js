...
const Addnewproduct = () => {
  ...
  const handleUpload = async () => {
    ...
    if (!ProductData.category_id) {
      toast.error(
        "Please create at least one product category before adding new products.!"
      );
      return;
    }
    ...
    const toastId = toast.loading("Uploading product don't exit...");
    try {
      ...
      <div className="right">
        <div className="upright">
          <div className="d-flex">
            ...
            <button
              disabled={OtherPicture.length === 0 ? true : false}
              onClick={() => setOtherPicture([])}
          ...
          <div className="uploadImg d-flex">
            ...
            >
              {topicImg == null ? (
                ...
                <>
                  <img
                    src={URL.createObjectURL(topicImg)}
                    style={{
                      width: "100%",
                      height: "100%",
                      borderRadius: "10px",
            ...
            <div className="UploadO9ss">
              ...
              <div className="AnotherIMG">
                {Array.isArray(OtherPicture) &&
                  OtherPicture.map((file, id) => (
                    <img
                      key={id}
              ...
              {filterProduct?.map((item, index) => (
                <>
                  <div
                    ...
                    className={
                      ProductData.category_id == item?.id
                        ? "cardItemActive"
                        : "cardItem"
                    }
                  >
