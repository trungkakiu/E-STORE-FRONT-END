...
const UpdateCategory = ({ show, close, data, data2 }) => {
    ...
    const updateCategory = async () => {
        ...
        try {
            const response = await ResfulAPI.UpdateCate(
                        ...
                        <div className="inputraw">
                           ...
                           <div className="category-parent">
                                    ...
                                    {Array.isArray(data2) &&
                                        data2
                                            ...
                                            .map((item) => (
                                                <div
                                                    key={item.id}
                                                    className={`item ${selectedParentId === item.id ? "itemchoose" : ""}`}
                                                    onClick={() => {
                            ...
                            <div className="d-flex button">
                                ...
                                <div onClick={updateCategory} className="btn success">Submit</div>
                            </div>
                        </div>
                    </div>
                </Modal.Body>
