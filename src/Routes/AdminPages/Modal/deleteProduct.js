                ...
                <Modal.Body style={{height: "40%"}}>
                    ...
                    <div className="DeleteProduct-container">
                        <div className="contents">
                            <p className="p7762">Are you sure you want to delete this product? 🤓</p>
                            <div className="d-flex button">
                                <button onClick={()=>close()} className={isLoad?("btn disdell-active"):("btn disdell")}>Cancel</button>
                                <button onClick={()=>deleteProduct()} className={isLoad?("btn dell-active"):("btn dell")}>{isLoad? ("Deleting..."):("Confirm")}</button>
                            </div>
                        </div>
                    </div>
                </Modal.Body>
