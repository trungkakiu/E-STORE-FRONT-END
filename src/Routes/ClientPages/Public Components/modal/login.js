...
const loginPartVariants = {
  ...
  exit: { opacity: 0, x: 150, scale: 0.8, transition: { duration: 0.2 } },
};
...
const LoginModal = ({ show, close, message }) => {
  ...
  const testRegisterValue = () => {
    try {
      ...
      if (!loginpart.Repassword) {
        ...
        loginStatus.Repassword === "invalid_norepeat" ||
        loginStatus.Repassword === "invalid_length"
      ) {
  ...
  const testLoginValue = () => {
    try {
      if (!loginpart.EmailorPhonenumber) {
        ...
        showToast(
          "short-email",
          "Email or phone number must be at least 10 characters 👌"
        );
        return false;
      }
    ...
    try {
      if (testLoginValue()) {
        ...
        if (response.status === 200) {
          const profile = await ResfulAPI.Getprofile(
      ...
      if (testRegisterValue()) {
        ...
        if (response.status === 400) {
          ...
          if (!toast.isActive(badRequestId)) {
            toast.error(
              "Please fill out all required fields or check minimum length ⏺️",
              {
                containerId: "LOGIN",
  ...
  const opentModal = (code) => {
    if (code === "forgot") {
      setModalState((prev) => ({ ...prev, forGot: true }));
      return;
    }
  };
  ...
  const closeModal = (code) => {
    if (code === "forgot") {
      setModalState((prev) => ({ ...prev, forGot: false }));
      return;
    }
  };
  ...
  return (
    <Modal show={show} onHide={close}>
      <ForgotPassword
        show={ModalState.forGot}
        close={() => closeModal("forgot")}
      />
        ...
        <Modal.Body>
          <div className="login-body">
            <div className="header-modal">
              <div className="title">
                <p className="title_1">Sign in / Register</p>
                <p className="title_2">All data will be encrypted</p>
              </div>
              <div className="icon-header d-flex">
                <div className="icon_1">
                  ...
                  <div className="text-group">
                    <p className="pr_01">Free shipping</p>
                    <p>on all orders</p>
                  </div>
                </div>
                <div className="icon_2">
                  ...
                  <div className="text-group">
                    <p className="pr_02">Free Returns</p>
                    <p>Up to 90days</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="input-values">
                    <div className="d-flex form flex-column">
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          handleInputChange(event, "EmailorPhonenumber")
                        }
                    ...
                    <div className="d-flex form flex-column">
                      ...
                      <div className="d-flex">
                        ...
                        <input
                          ...
                          onKeyDown={handleKeyDown}
                          onChange={(event) =>
                            handleInputChange(event, "Repassword")
                          }
